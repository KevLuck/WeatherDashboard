...
// Applies the weather data to the today card and then launches the five day
// forecast
function getWeatherToday() {
    ...
    $
        .ajax({url: getUrlCurrent, method: 'GET'})
...
function getFiveDayForecast() {
    ...
    $
        .ajax({url: getUrlFiveDay, method: 'GET'})
        .then(function (response) {
